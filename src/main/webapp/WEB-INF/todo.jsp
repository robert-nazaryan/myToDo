...
<div class="container m-5 p-2 rounded mx-auto bg-light shadow">
    ...
    <div class="row mx-1 px-5 pb-3 w-80">
        <div class="col mx-auto">
                ...
                <div class="col-auto m-1 p-0 todo-actions">
                    <div class="row d-flex align-items-center justify-content-end">
                        <form action="/editToDo" method="get">
                            ...
                            <h5 class="m-0 p-0 px-2">
                                <button type="submit" class="fa fa-pencil text-info btn m-0 p-0" data-toggle="tooltip"
                        ...
                        <form action="/deleteToDo" method="get">
                            ...
                            <h5 class="m-0 p-0 px-2">
                                <button type="submit" class="fa fa-trash-o text-danger btn m-0 p-0"
                                        data-toggle="tooltip"
                                        data-placement="bottom" title="Delete todo"></button>
                            </h5>
                        </form>
                    </div>
                    <div class="row todo-created-info">
                        <div class="col-auto d-flex align-items-center pr-2">
                            ...
                            <label class="date-label my-2 text-black-50"><%=todo.getCreatedDate().toString()%>
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row px-3 align-items-center todo-item rounded">
                <div class="col-auto m-1 p-0 d-flex align-items-center">
                    <form action="/markDone" method="get">
                        <input type="hidden" value="<%=todo.getId()%>" name="todoId">
                        <h2 class="m-0 p-0">
                            <button type="submit" class="fa fa-square-o text-primary btn m-0 p-0" data-toggle="tooltip"
                                    data-placement="bottom"
                                    title="Mark as complete"></button>
                            <button type="submit" class="fa fa-check-square-o text-primary btn m-0 p-0 d-none"
                                    data-toggle="tooltip"
                                    data-placement="bottom" title="Mark as todo"></button>
                        </h2>
                    </form>
                </div>
                <div class="col px-1 m-1 d-flex align-items-center">
                ...
                <div class="col-auto m-1 p-0 px-3">
                    <div class="row">
                        <div class="col-auto d-flex align-items-center rounded bg-white border border-warning">
                            ...
                            <h6 class="text my-2 pr-2"><%=todo.getFinishedDate().toString()%>
                            </h6>
                        </div>
                    </div>
                </div>
